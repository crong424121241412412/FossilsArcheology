...
public class ItemTerrorBirdEgg extends Item
{
    ...
    public ItemTerrorBirdEgg(int terrorBirdEggID, boolean isCultivated)
    {
        super(terrorBirdEggID);
    ...
    @SideOnly(Side.CLIENT)
    @Override
    public void getSubItems(int item, CreativeTabs creativeTab, List list)
    {
